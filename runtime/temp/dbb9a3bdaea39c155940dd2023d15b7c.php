<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"G:\Adobe\phpStudy\WWW\shop/application/index\view\index\index.html";i:1574688877;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <div class="header">
    <div class="headerLayout w1200">
      <div class="headerCon">
        <h1 class="mallLogo">
          <a href="#" title="网上书城">
            <img src="/shop/public/demo/res/static/img/logoA.png">
          </a>
        </h1>
        <div class="mallSearch">
          <form action="<?php echo url('select'); ?>" class="layui-form" method="post" name="key" novalidate>
            <input type="text" name="key" required  lay-verify="required" autocomplete="off" class="layui-input" placeholder="请输入关键字" >
  ...
  <div class="content">
    ...
    <div class="category-con">
        ...
        <div class="category-tab-content">
          <div class="nav-con">
            <ul class="normal-nav layui-clear">
              <?php if(is_array($left_list) || $left_list instanceof \think\Collection || $left_list instanceof \think\Paginator): $_5ddbd8751155a = is_array($left_list) ? array_slice($left_list,0,10, true) : $left_list->slice(0,10, true); if( count($_5ddbd8751155a)==0 ) : echo "" ;else: foreach($_5ddbd8751155a as $key=>$vo): ?>
              <li class="nav-item">
      ...
      <div class="category-banner">
        <div class="w1200">
          <img src="/shop/public/demo/res/static/img/bannerA.jpg">
        </div>
      </div>
    </div>
  ...
  <div class="footer">
    <div class="ng-promise-box">
      <div class="ng-promise w1200">
        <p class="text">
          <a class="icon1" href="javascript:;">无理由退换货</a>
          <a class="icon2" href="javascript:;">全场免邮</a>
          <a class="icon3" style="margin-right: 0" href="javascript:;">正品保证</a>
        </p>
      </div>
    </div>
    <div class="mod_help w1200">                                     
    
      <p class="coty">软工B班12小组网上书城</p>
    </div>
  </div>
