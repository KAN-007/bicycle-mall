<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"G:\Adobe\phpStudy\WWW\shop/admin/index\view\index\index.html";i:1552017353;s:59:"G:\Adobe\phpStudy\WWW\shop\admin\index\view\Index\base.html";i:1574690675;s:62:"G:\Adobe\phpStudy\WWW\shop\admin\index\view\Index\sidebar.html";i:1552017340;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">                    
                    ...
                    <p>
                        <a class="btn btn-app btn-default no-radius" href="<?php echo url('Type/index'); ?>">
                            <i class="icon-group bigger-230"></i>
                            分类管理
                        </a>
                        <a class="btn btn-app btn-default no-radius" href="<?php echo url('Brand/index'); ?>">
                            <i class="icon-group bigger-230"></i>
                            品牌管理
                        </a>
                        <a class="btn btn-app btn-default no-radius" href="<?php echo url('Goods/index'); ?>">
                            <i class="icon-group bigger-230"></i>
                            商品管理
                        </a>
                        <a class="btn btn-app btn-default no-radius" href="<?php echo url('User/index'); ?>">
                            <i class="icon-group bigger-230"></i>
                            用户管理
                        </a>
