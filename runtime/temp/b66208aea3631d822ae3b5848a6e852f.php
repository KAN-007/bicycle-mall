<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\phpStudy\WWW\shop/application/index\view\index\select.html";i:1592122408;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
      ...
      <div class="headerCon">
        ...
        <div class="mallSearch">
          <form action="<?php echo url('select'); ?>" class="layui-form" method="post" name="key" novalidate>
            <input type="text" name="key" required  lay-verify="required" autocomplete="off" class="layui-input" placeholder="请输入需要的商品" value="<?php echo $key; ?>">
