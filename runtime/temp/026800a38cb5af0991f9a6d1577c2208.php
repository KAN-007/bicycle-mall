<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\phpStudy\WWW\shop/application/index\view\index\index.html";i:1592122005;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body id="list-cont">
  ...
  <div class="content">
    ...
    <div class="category-con">
        ...
        <div class="category-tab-content">
          <div class="nav-con">
            <ul class="normal-nav layui-clear">
              <?php if(is_array($left_list) || $left_list instanceof \think\Collection || $left_list instanceof \think\Paginator): $_5ee5da9d5e317 = is_array($left_list) ? array_slice($left_list,0,10, true) : $left_list->slice(0,10, true); if( count($_5ee5da9d5e317)==0 ) : echo "" ;else: foreach($_5ee5da9d5e317 as $key=>$vo): ?>
              <li class="nav-item">
      ...
      <div class="category-banner">
        <div class="w1200">
          <img src="/shop/public/demo/res/static/img/banner4.jpg">
        </div>
      </div>
    </div>
  ...
  <div class="footer">
    ...
    <div class="mod_help w1200">                                     
      ...
      <p class="coty"> 软件工程-17053024-张健斌 </p>
    </div>
  </div>
