<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"G:\Adobe\phpStudy\WWW\shop/admin/index\view\order\index.html";i:1552026158;s:59:"G:\Adobe\phpStudy\WWW\shop\admin\index\view\Index\base.html";i:1574690675;s:62:"G:\Adobe\phpStudy\WWW\shop\admin\index\view\Index\sidebar.html";i:1552017340;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <form action="<?php echo url('index'); ?>" method="get">
                                    <div class="input-group pull-right">
                                        <input class="form-control search-query" type="text"  name="uname" value="<?php echo $uname; ?>" placeholder="输入订单编号...">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="center">
                                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                                ...
                                                                <?php endif; if($v['status'] == 4 and $v['revaluate'] == ''): ?>
                                                                 <a class="blue" href="<?php echo url('revaluate',['id'=>$v['id']]); ?>">
                                                                    回复评论
                                                                </a>
                                                                <?php endif; ?>
                                                            </div>
                    ...
                    <div class="modal-dialog" style="width:300px;">
                        <div class="modal-content" style="top:160px;left:80%;">
                            <div class="modal-header" style="height:40px;padding:5px 10px;line-height:30px;">
                                ...
                                <p class="bigger-120" id="myModalLabel">发货</p>
                            </div>
                            <div class="modal-body" style="height:70px;padding:5px 10px;line-height:60px;">
                                <p class="text-danger bigger-150">确定要发货么</p>
                            </div>
    ...
    <script type="text/javascript">
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            if (data == 1) {
                                warningInfo("#success-info","发货成功！");
                                location.href='';
                            }else if(data == 2){
                                warningInfo("#error-info","没有发货权限！");
                            }else{
                                warningInfo("#error-info","发货失败！");
                            }
