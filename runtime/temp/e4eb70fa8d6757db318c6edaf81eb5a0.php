<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"G:\Adobe\phpStudy\WWW\shop/admin/index\view\brand\insert.html";i:1551946217;s:59:"G:\Adobe\phpStudy\WWW\shop\admin\index\view\Index\base.html";i:1543299813;s:62:"G:\Adobe\phpStudy\WWW\shop\admin\index\view\Index\sidebar.html";i:1552017340;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								添加品牌<a class="btn btn-info btn-sm pull-right" href="<?php echo url('index'); ?>">
							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="<?php echo url('add'); ?>" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" placeholder="名称" type="text" name="name">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 排序 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" placeholder="排序" type="text" name="order">
										</div>
									</div>
									<div class="form-group">
