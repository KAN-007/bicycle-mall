<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"G:\Adobe\phpStudy\WWW\shop/application/index\view\i\login.html";i:1574684669;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
          ...
          <form class="layui-form" action="<?php echo url('doLog'); ?>" type="post">
            ...
            <div class="layui-form-item login-btn">
              ...
              <div style="margin-top:15px;text-align:center">
                <p><a href="<?php echo url('register'); ?>">注册</a></p>
              </div>
            </div>
          </form>
        </div>
