<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"F:\wamp\www\shop/application/index\view\index\typelist.html";i:1552133104;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
      ...
      <div class="commod-cont w1200 layui-clear">
        ...
        <div class="right-cont-wrap">
          <div class="right-cont">
            <div style="font-size:25px;font-weight:bold;font-family:'Comic Sans MS', cursive, sans-serif;color:#cfb2f6">
              品牌：
                <?php if(is_array($brand_list) || $brand_list instanceof \think\Collection || $brand_list instanceof \think\Paginator): if( count($brand_list)==0 ) : echo "" ;else: foreach($brand_list as $key=>$vo): ?>
                  <span><a href="<?php echo url('typelist',['bid'=>$vo['id'],'tid'=>$tid]); ?>"><font color="#cfb2f6"><?php echo $vo['name']; ?></font></a></span>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
