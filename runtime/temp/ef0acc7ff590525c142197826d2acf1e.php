<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"G:\Adobe\phpStudy\WWW\shop/admin/index\view\type\index.html";i:1551940404;s:59:"G:\Adobe\phpStudy\WWW\shop\admin\index\view\Index\base.html";i:1574690675;s:62:"G:\Adobe\phpStudy\WWW\shop\admin\index\view\Index\sidebar.html";i:1552017340;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php if(is_array($type) || $type instanceof \think\Collection || $type instanceof \think\Paginator): if( count($type)==0 ) : echo "" ;else: foreach($type as $key=>$v): ?>
                                        ...
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                            <tr>
                                                <td colspan=11><?php echo $type->render(); ?></td>
                                            </tr>
                                            <!--一行的结束-->
                                        </tbody>
                                    </table>
